...
- 📖 [新概念英语全四册（在线课文朗读、单句点读、中英对照）](https://github.com/iChochy/NCE) — iChochy
- [MuJing](https://github.com/tangshimin/MuJing) — 通过电影、美剧或文档中的真实语境学习英语单词的应用

#### 🤖 AI Learning

- 📖 [AI Agents The Definitive Guide](https://github.com/Nicolepcx/ai-agents-the-definitive-guide) — Nicolepcx（配套仓库：Agent 设计模式、LangChain/LangGraph 多智能体、部署与评测）

#### 💻 Programming

- 📖 [µGo 语言实现](https://github.com/wa-lang/ugo-compiler-book) — wa-lang（Go 编译器学习）
- 📖 [Go 语言定制指南](https://github.com/chai2010/go-ast-book) — chai2010（Go 语法树入门）
