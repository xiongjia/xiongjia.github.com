...
- [kodi](https://kodi.tv/); [kodi-github](https://github.com/xbmc)
...
- [imdb](https://www.imdb.com/) - 缺少开放接口
- [omdbapi](https://www.omdbapi.com/) - 基本不维护
- [tmdb](https://www.themoviedb.org/) - 目前看最开放

## Image / File Hosting

- [CloudFlare-ImgBed](https://github.com/MarSeventh/CloudFlare-ImgBed) - 基于 Cloudflare 的自托管图床/文件托管（R2 / S3 / WebDAV 等）
